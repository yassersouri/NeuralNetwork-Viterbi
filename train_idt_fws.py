...
def main(data_root, result_root, split, seed, feat_window_size, no_prior):
    ...
    trainer = Trainer(decoder, dataset.input_dimension, dataset.n_classes, buffer_size = len(dataset), buffered_frame_ratio = 25, feat_window_size=feat_window_size, no_prior=no_prior)
    learning_rate = 0.01
